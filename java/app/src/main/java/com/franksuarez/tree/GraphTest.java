 ...
 * @author franksuarez
 */
public class GraphTest implements Graph<Integer> {
    public class VertexTest implements Vertex<Integer> {
    ...
    public class EdgeTest implements Edge<Integer> {
    ...
    @Override
    public Integer get_vertex_value(Vertex v) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public void set_vertex_value(Vertex v, Integer value) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    ...
    @Override
    public void set_edge_value(Vertex v1, Vertex v2, Integer value) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
